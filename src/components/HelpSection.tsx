...
import { HelpCircle, Terminal, BookOpen, Settings, Layers, Calendar, Info, Subtitles, AlertCircle, ChevronDown, ChevronRight, HelpCircle as FaqIcon, CheckCircle, Folder, Heart } from 'lucide-react';
